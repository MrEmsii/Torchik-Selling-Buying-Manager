...
def Test(session):
    ...
    for i in range(1, d*(16+1)):
        ...
        art_1 = Artykul_Lista(nazwa="Azbest"+str(random.randint(1,g)), kategoria_id=random.randint(1, i), firma_id=random.randint(1, i))
    ...
    for i in range(1, g+1):
        session.execute(artykuly_relacja.insert().values(
            ...
            cena_jednostkowa=random.randint(1, 100),
